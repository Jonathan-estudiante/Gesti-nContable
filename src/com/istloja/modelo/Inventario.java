...
public class Inventario {
    ...
    public Inventario(int id_inventario, String codigo_pro, int can_productos, String descripcion, double precios_compra_sin_iva, double precios_compra_con_iva, double precio_mayorista, double precio_cliente_fijo, double precio_cliente_normal, Date fecha_caducidad, Date fecha_registro, Date fecha_actualizacion) {
